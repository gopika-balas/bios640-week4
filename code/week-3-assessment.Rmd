---
title: "Week 3 Assessment - Modified"
...
## {.tabset}
### Individual plots describing gender and ethnicity distribution 
```{r}
#plot 1
# first the required dataset is imported
nhanes_data <- import(here("datasets/week-3-datasets", "cleaned_NHANES.csv"))
...
### Combined plots describing gender and ethnicity distribution 
...
Exploring the NHANES data set (note that only first 100 rows are displayed due to dataset being large)
```{r, results = 'markup'}
datatable(head(nhanes_data, 1000),
...
diet_data <- import(here("datasets/week-3-datasets", "diet.csv"))
